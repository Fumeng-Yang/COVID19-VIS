...
"#FABFD2", "#B07AA1", "#D4A6C8", "#9D7660", "#D7B5A6", "#dddddd", "steelblue", "yellow")
...
df_states %>% group_by(date) %>%
    ...
    ungroup() %>%
    ggplot() + 
     geom_label(x = first_day, y = 150000, color = "darkgray", label = "total positive: ", size = 2, hjust = 0) +
     geom_text(mapping = aes(x = date, y = 150000, label = total), color = "darkgray", size = 2, angle = 90, hjust = 0) +
     geom_label(x = first_day, y = 120000, color = tableau10[1], label = "hospitalizedCurrently", size = 2, hjust = 0) +
     geom_label(x = first_day, y = 125000, color = tableau10[2], label = "positiveIncrease", size = 2, hjust = 0) +
     geom_line(mapping = aes(x = date, y = hospitalizedCurrently), alpha = 0.7, color = tableau10[1], size = LINE_SIZE) +
...
df_states %>%
    ...
    ggplot() +
      ...
      scale_y_continuous(breaks = seq(-30000, 30000, by = 5000), labels = c("30000","25000","20000", "15000", "10000", "5000", "0", "5000", "10000", "15000", "20000", "24000","30000")) +
