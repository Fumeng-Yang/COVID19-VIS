...
"#FABFD2", "#B07AA1", "#D4A6C8", "#9D7660", "#D7B5A6", "#dddddd", "steelblue")
...
df_states %>% group_by(date) %>%
    ...
    ungroup() %>%
    ggplot() + 
     geom_label(x = first_day, y = 120000, color = "darkgray", label = "total positive: ", size = 2, hjust = 0) +
     geom_text(mapping = aes(x = date, y = 120000, label = total), color = "darkgray", size = 2, angle = 90, hjust = 0) +
     geom_label(x = first_day, y = 100000, color = tableau10[1], label = "hospitalizedCurrently", size = 2, hjust = 0) +
     geom_label(x = first_day, y = 105000, color = tableau10[2], label = "positiveIncrease", size = 2, hjust = 0) +
     geom_line(mapping = aes(x = date, y = hospitalizedCurrently), alpha = 0.7, color = tableau10[1], size = LINE_SIZE) +
